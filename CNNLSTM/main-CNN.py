...
from keras.layers import Input, Conv1D, MaxPooling1D, LSTM, Dense, Dropout, SimpleRNN, Bidirectional
...
def build_model(input_shape):
    ...
    # **使用 GlobalAveragePooling1D 代替 Flatten**
...
def main():
    ...
    # 准备数据
    X, y,dates = prepare_data('data/CSI500.csv', WINDOW_SIZE, FUTURE_DAYS)
    ...
    plt.suptitle('SSE Index Predictions in CNN Model', fontsize=16)
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('results/SSE-cnn-only-predictions-LSTM.png')
    plt.show()
